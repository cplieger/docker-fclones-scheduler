# check=error=true
FROM rust:1.96-trixie@sha256:fb328f0f58becb23ba1719940a2c94ece8b0b48afa837d05b79ef64bc1e18f6e AS fclones-builder
...
FROM golang:1.26-trixie@sha256:0f4938e8d12c5c64fbf0d5d15e950c437ad4c65f761890cfbb466fee75a7bbaa AS go-builder
